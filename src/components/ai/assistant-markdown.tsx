...
const markdownComponents: Components = {
  ...
  li: ({ children }) => <li className="pl-0.5 leading-5 marker:text-neutral-400">{children}</li>,
  blockquote: ({ children }) => (
  ...
  thead: ({ children }) => <thead className="bg-[#FAF8F2] text-neutral-700">{children}</thead>,
  tbody: ({ children }) => <tbody className="divide-y divide-[#EEE9E0]">{children}</tbody>,
  tr: ({ children }) => <tr className="even:bg-[#FFFCF8]">{children}</tr>,
  th: ({ children }) => <th className="whitespace-nowrap px-3 py-2 font-extrabold">{children}</th>,
  td: ({ children }) => <td className="px-3 py-2 align-top text-neutral-700">{children}</td>,
  pre: ({ children }) => (
