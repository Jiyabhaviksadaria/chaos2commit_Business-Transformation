...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[24px] border border-[#E5DFD4] bg-white text-neutral-900 shadow-xs transition-all",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "text-base sm:text-lg font-extrabold tracking-tight text-neutral-900",
      className
    )}
    {...props}
  />
