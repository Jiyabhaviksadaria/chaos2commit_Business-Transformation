...
function inferAuthUrl(): string {
  ...
  if (vercelEnv === "preview") {
    if (vercelBranchUrl) return `https://${vercelBranchUrl}`;
...
const envSchema = z.object({
  ...
  GROQ_QWEN_API_KEY: z.string().optional(),
  GROQ_WEBSITE_MODEL: z.string().optional().default("qwen/qwen3.8-27b"),
  GROQ_ASSISTANT_MODEL: z.string().optional().default("qwen/qwen3.8-27b"),
  ...
  APP_URL: z.string().optional().default(inferredAuthUrl),
});
...
export const env = parsed.success
  ...
  : {
      ...
      GROQ_QWEN_API_KEY: process.env.GROQ_QWEN_API_KEY,
      GROQ_WEBSITE_MODEL: process.env.GROQ_WEBSITE_MODEL || "qwen/qwen3.8-27b",
      GROQ_ASSISTANT_MODEL: process.env.GROQ_ASSISTANT_MODEL || "qwen/qwen3.8-27b",
